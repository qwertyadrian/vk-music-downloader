...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.login.setGeometry(QtCore.QRect(370, 10, 181, 31))
        self.login.setObjectName("login")
        self.login_text = QtWidgets.QLabel(self.centralwidget)
        self.login_text.setGeometry(QtCore.QRect(70, 10, 291, 31))
        font = QtGui.QFont()
        ...
        self.password_text.setGeometry(QtCore.QRect(300, 50, 61, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.password.setGeometry(QtCore.QRect(370, 50, 181, 31))
        ...
        self.link_text.setGeometry(QtCore.QRect(9, 90, 351, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.user_link.setGeometry(QtCore.QRect(370, 90, 181, 31))
        ...
        self.saveData.setGeometry(QtCore.QRect(560, 90, 111, 27))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.link_text.setText(_translate("MainWindow", "Ссылка на профиль (пост) пользователя (сообщества):"))
